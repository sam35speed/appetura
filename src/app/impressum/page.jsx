    ...
    <FadeIn>
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
          {[
            ['Careers', 'careers@appeturaagency.com'],
            ['Press', 'press@appeturaagency.com'],
          ].map(([label, email]) => (
            <div key={email}>
  ...
  return (
    <>
      <PageIntro title="Impressum">
        <p>Betreiber der Website von appetura.de ist: </p>
<p>Samuel Spet </p>
<p>Tirolerstraße 17 </p>
<p>87629 Füssen </p>
<p>Deutschland </p>
<p>E-Mail: sam@appetura.de </p>
<p>Inhaltlich verantwortlich: Samuel Spet </p>
